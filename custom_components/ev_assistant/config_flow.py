...
def build_evcc_schema(cur: dict) -> vol.Schema:
    ...
    return vol.Schema({
        ...
        vol.Optional(CONF_EVCC_PV_POWER,          description=sv(CONF_EVCC_PV_POWER)):          _EVCC_POWER_SENSOR,
        vol.Optional(CONF_EVCC_GRID_POWER,        description=sv(CONF_EVCC_GRID_POWER)):        _EVCC_POWER_SENSOR,
        vol.Optional(CONF_EVCC_BATTERY_POWER,     description=sv(CONF_EVCC_BATTERY_POWER)):     _EVCC_POWER_SENSOR,
    })
