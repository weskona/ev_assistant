...
| `range_estimate` | Geschätzte Reichweite | Aktueller SoC × nutzbare Akkukapazität ÷ tatsächlicher Verbrauch (kWh/100 km) — nutzt den rollierenden 30-Tage/50-km-Fahrtenbuch-Schnitt, falls vorhanden, sonst den Lebenszeit-Schnitt `vehicle_avg_consumption`. Attribut `verbrauch_kwh_100km` zeigt den verwendeten Verbrauchswert. `unknown` ohne SoC oder ohne jeden Verbrauchswert. |
